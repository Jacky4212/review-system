...
if old in c:
    ...
    print('not found')
    # Debug: find a unique fragment
    idx = c.find('与非运算')
    if idx >= 0:
        print('Found near:', repr(c[idx:idx+80]))
